...
- **`stitch-dark.html`** — тёмная тема под Google Stitch: готовый промпт EN + RU (кнопка копирования), таблица «поле панели Theme → значение» с подписями EN/RU, все тёмные токены + акцент на тёмном (#8FBBE0 / #7FB0DA), быстрый справочник типографики и геометрии.
