...
Обновлено: 2026-06-24 · версия **v0.60**
...
- **Последние улучшения (v0.60):** Оптимизация скорости — обложки −77% (848→194KB, WebP 800px), `_headers` Cloudflare кэш (images 1 нед, `/_astro/*` 1 год), `preload="none"` на видео (−7.4MB при загрузке главной/coordo).
