...
Обновлено: 2026-06-23 · версия **v0.51**
...
## Что готово (live)
- **43 страницы (вкл. 404):** главная · продукт + 3 контура + vs-разработка + **pricing** · модули + замещения · услуги + 8 направлений внедрения + разработка · 5 отраслей · 2 сравнения · пресс-центр + **12 статей (все live)** · ELMA365 · о компании · контакты (форма-демо с плейсхолдерами) · 404.
