...
Обновлено: 2026-06-23 · версия **v0.48**
...
## Что готово (live)
- **33 страницы (вкл. 404):** главная · продукт + 3 контура + vs-разработка + **pricing** · модули + замещения · услуги + 8 направлений внедрения + разработка · 5 отраслей · 2 сравнения · пресс-центр + 2 статьи · ELMA365 · о компании (с реальной командой и фото) · контакты (форма-демо) · 404.
- **Визуал:** тёмный hero → светлый контент; **hero split-layout**; **feature bento** (3 dark-карточки с CSS-анимациями: согласование, корреспонденция, аналитика) (текст + looping video card справа — `public/video/demo.mp4`, плейсхолдер); структурная сетка в hero (raw aesthetic); кольцо-метрика; степперы; reveal-анимации; hover-карточки; бургер-меню; хлебные крошки (все 31 контентная страница покрыты); motion tokens, back-to-top, trust-чипы hero, 4-колонный футер, FAQ-аккордеоны, active nav. Светлый премиум, акцент indigo `#4F46E5`, шрифт Inter (ADR-0011). Fluid type на h3/lead через `clamp()`.
