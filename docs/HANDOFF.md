...
Обновлено: 2026-06-24 · версия **v0.57**
...
- **Последние улучшения (v0.57):** `/press/` — featured-карточка + цветные обложки по тегу + фильтры + блок соцсетей (5 платформ). `/coordo/` — voice-card с контрастом, исправлен переключатель валют, выровнено ядро. `/services/vnedrenie/` — timeline 6 шагов с описаниями.
