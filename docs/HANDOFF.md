...
Обновлено: 2026-06-25 · версия **v0.61**
...
- **Последние улучшения (v0.61):** QA-аудит `/products/express/` — фикс контраста hero-дашборда (`.dash{color:var(--text)}`: заголовок и KPI «2 дня/14/0» были near-white на белом → теперь читаются; глобально для всех `.dash`), JSON-LD `url`/`offers.url` приведены к виду со слэшем.
