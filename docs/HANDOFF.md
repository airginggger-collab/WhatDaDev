...
Обновлено: 2026-06-20 · версия **v0.40**
...
- **Визуал:** тёмный hero → светлый контент; продукт-герой с анимированным дашбордом; кольцо-метрика; степперы; reveal-анимации; hover-карточки; бургер-меню; хлебные крошки. Светлый премиум, акцент indigo `#4F46E5`, шрифт Inter (ADR-0011).
