...
Обновлено: 2026-06-23 · версия **v0.50**
...
## Что готово (live)
- **35 страниц (вкл. 404):** главная · продукт + 3 контура + vs-разработка + **pricing** · модули + замещения · услуги + 8 направлений внедрения + разработка · 5 отраслей · 2 сравнения · пресс-центр + **4 статьи** (+ 8 «скоро») · ELMA365 · о компании · контакты (форма-демо с плейсхолдерами) · 404.
