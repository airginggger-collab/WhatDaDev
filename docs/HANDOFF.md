...
Обновлено: 2026-07-04 · версия **v0.69**
...
- **Личный кабинет (v0.69, ADR-0015):** Sveltia CMS на `/admin/`, вход по GitHub-токену. Редактируемо: главная (`home.json`), цены Coordo (`pricing.json`), контакты (`contacts.json`), команда, направления, отрасли. Инструкция — `docs/editing-cabinet.md`. Этап 2 (статьи) — план в `docs/19-cms-migration.md`.
