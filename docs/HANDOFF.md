...
Обновлено: 2026-06-20 · версия **v0.34**
...
## Что готово (live)
- **32 страницы (вкл. 404):** главная · продукт + 3 контура + vs-разработка · модули + замещения · услуги + 8 направлений внедрения + разработка · 5 отраслей · 2 сравнения · пресс-центр + 2 статьи · ELMA365 · о компании (с реальной командой и фото) · контакты (форма-демо) · 404.
