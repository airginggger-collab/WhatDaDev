...
Обновлено: 2026-06-24 · версия **v0.59**
...
- **Последние улучшения (v0.59):** `/press/`, `/services/`, `/industries/` — обложки карточек: чистые скрины ELMA365 без цветного оверлея + тёмный градиент снизу. Соцкарточки `/press/`: убраны цветные border-top, правильные brand-иконки (Telegram/Instagram/YouTube/TikTok/VK) с круглым фоном.
