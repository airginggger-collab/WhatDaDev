...
lead: "1С:Документооборот остаётся привычным выбором для компаний на экосистеме 1С. ELMA365 представляет собой low-code BPM-платформу с акцентом на гибкость процессов. Разбираем, чем они отличаются и когда стоит выбрать каждую."
eyebrow: "Сравнение"
crumbs:
  - name: "Главная"
    href: "/"
...
faq:
  - q: "В чём главное отличие ELMA365 от 1С:Документооборот?"
    a: "ELMA365 представляет собой low-code BPM-платформу: она строится вокруг гибких процессов, которые можно моделировать и менять без программирования. 1С:ДО остаётся учётной системой с жёсткой логикой документооборота, ориентированной на регламентированный ОРД и интеграцию с учётом 1С."
  ...
  - q: "Какую платформу выбрать, если у нас уже есть 1С:ERP?"
    a: "Если задача сводится к документообороту в рамках 1С-экосистемы, 1С:ДО становится логичным выбором: нативная интеграция, одна экосистема. Если нужны сложные кросс-функциональные процессы (заявки, согласования, задачи, КЭДО) поверх 1С, ELMA365 даст больше гибкости и меньше доработок."
draft: false
---
  ...
  <section class="section alt">
    <div class="container">
      ...
      <p class="muted" style="margin-top:8px;max-width:640px">Оценки условные и зависят от конкретной задачи. Таблица даёт точки старта для анализа, а не окончательный вердикт.</p>
    ...
    <div class="container">
      ...
      <div class="grid grid-2" style="margin-top:24px">
        <div class="card">
          ...
          <p style="margin-top:12px">Данные (документы, справочники, сущности) живут внутри процессов или рядом с ними как объекты приложений. Зависимость от разработчиков низкая: администратор ELMA365 решает 80% задач самостоятельно.</p>
        </div>
        <div class="card">
          <h3>1С:ДО: документ как центр</h3>
          <p>1С:Документооборот представляет собой учётную систему. В центре находится документ с атрибутами, регистрационной карточкой и жизненным циклом по регламенту. Хорошо решает задачи, которые уже формализованы в ГОСТах и корпоративных регламентах ОРД.</p>
          <p style="margin-top:12px">Чтобы изменить логику, нужно открыть конфигуратор и писать код на языке 1С. Это нормально, если у компании есть 1С-программист и устоявшийся регламент, который редко меняется.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="section alt">
    <div class="container">
      ...
      <p class="muted" style="margin-top:8px;max-width:660px">Обе платформы зрелые, работают в тысячах компаний. Разница состоит в акцентах и сценариях применения.</p>
    ...
    <div class="container">
      ...
      <div class="grid grid-3" style="margin-top:28px">
        ...
        <div class="card">
          ...
          <p style="margin-top:14px;font-size:14px">Для компаний с требованиями по локализации данных. Дополнительно оплачиваются лицензии на пользователей и модули.</p>
        </div>
        <div class="card">
          ...
          <p style="margin-top:14px;font-size:14px">Клиентские лицензии ~5 000–7 000 руб./шт. разово. 1С:Технология хранения данных оплачивается отдельно. Обновления через ИТС.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="section alt">
    <div class="container">
      ...
      <div class="grid grid-2" style="margin-top:24px">
        <div class="card">
          <h3>ELMA365</h3>
          <p>REST API и Webhook из коробки. Готовые коннекторы: 1С (ERP, УТ, Бухгалтерия), SAP, Microsoft Exchange, Directum, сервисы ЭДО (Диадок, Контур, СБИС). Интеграция с почтой, Telegram-ботами и внешними сервисами настраивается через low-code сценарии без разработки.</p>
          <p style="margin-top:12px">Подробнее о платформе рассказывает <a href="/elma365/" style="color:var(--accent)">обзор ELMA365</a>.</p>
        </div>
        <div class="card">
          <h3>1С:Документооборот</h3>
          <p>Нативная интеграция с линейкой 1С является главным преимуществом. Документы из 1С:ERP автоматически попадают в ДО без разработки. Интеграция с внешними системами идёт через COM-соединение или HTTP-сервисы и требует квалификации 1С-разработчика.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="grid grid-3" style="margin-top:24px">
        ...
        <div class="card">
          ...
          <p style="font-size:14px">1С:Бухгалтерия осталась для финансов, а ELMA365 отвечает за HR-процессы, заявки и КЭДО. Интеграция через коннектор: договоры из ELMA365 попадают в 1С автоматически. Два инструмента, каждый на своём месте.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="section alt">
    <div class="container">
      ...
      <p class="muted" style="margin-top:8px;max-width:660px">WhatDaDev является партнёром ELMA365 по внедрению. Мы не продаём платформу любой ценой: сначала разбираемся в задаче, потом рекомендуем.</p>
      <div class="steps">
        <div class="step">
          <div class="num">1</div>
          <h3>Аудит задачи</h3>
        ...
        <div class="step">
          <div class="num">3</div>
          <h3>Быстрый старт</h3>
          <p><a href="/products/express/" style="color:var(--accent)">Экспресс-внедрение</a> даёт первые рабочие процессы за 4–8 недель. Фиксированный объём и цена.</p>
        </div>
        <div class="step">
          <div class="num">4</div>
          <h3>Поддержка и развитие</h3>
          <p>После запуска идут техподдержка, обучение пользователей, расширение на новые отделы.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="faq" style="margin-top:28px">
          <details class="faq-item">
            ...
            <p class="faq-a">ELMA365 представляет собой low-code BPM-платформу: она строится вокруг гибких процессов, которые можно моделировать и менять без программирования. 1С:ДО остаётся учётной системой с жёсткой логикой документооборота, ориентированной на регламентированный ОРД и интеграцию с учётом 1С.</p>
          </details>
          <details class="faq-item">
          ...
          <details class="faq-item">
            ...
            <p class="faq-a">Если задача сводится к документообороту в рамках 1С-экосистемы, 1С:ДО становится логичным выбором: нативная интеграция, одна экосистема. Если нужны сложные кросс-функциональные процессы (заявки, согласования, задачи, КЭДО) поверх 1С, ELMA365 даст больше гибкости и меньше доработок.</p>
          </details>
      </div>
    </div>
  </section>
